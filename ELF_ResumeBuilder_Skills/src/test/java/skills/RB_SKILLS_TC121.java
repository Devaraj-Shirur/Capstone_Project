...
public class RB_SKILLS_TC121 extends Base_Class {
	...
	public void meanResumeBuild() {
		...
		String expectedFrontendTech = skillPage.getHtml().getText();
		...
		skillPage.getJms().click();
		String expectedMiddlewareTech = skillPage.getJms().getText();
		...
		skillPage.getHibernateWithJpa().click();
		String expectedBackendTech = skillPage.getHibernateWithJpa().getText();
		...
		String expectedDesignePattern = skillPage.getSingleton().getText();
